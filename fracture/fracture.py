...
class Fracture:
    ...
    def load_matrix(self):
        ...
        self.M = Fracture.load("FRAC0006_nrIter27.txt")
    ...
    def print_plotly(self):
        ...
        max_p = np.amax((self.M - self.mp) @ self.autovectors, axis=0)
        min_p = np.amin((self.M - self.mp) @ self.autovectors, axis=0)
        ...
        for i in range(2):
            for j in range(2):
                for k in range(2):
                    ...
                    box.append(self.mp + points @ self.autovectors.T)
